...
import {storeDetail, addLikeCat} from "../../reduxSlice/feedSlice";
      ...
      <div className="catCard" style={{backgroundColor: props.cardColor}}>
        ...
        <div className="catInfoContainer">
          ...
          <div className="rightCol">
            <svg onClick={() => dispatch(addLikeCat(cat))} width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
